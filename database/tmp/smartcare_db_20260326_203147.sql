...
--
-- Host: localhost    Database: smartcare_db
-- ------------------------------------------------------
...
CREATE TABLE `alert_logs` (
  ...
  `recipient_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接收手机号',
...
CREATE TABLE `cameras` (
  ...
  `camera_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `device_serial` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `fall_events` (
  ...
  `elder_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '路人时记录姓名',
  ...
  `process_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `relations` (
  ...
  `relationship` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '父子/母女等',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dump completed on 2026-03-26 12:31:47
